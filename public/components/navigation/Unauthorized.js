            ...
            <div>
                ...
                <div className="container g-pt-20 g-pb-20">
                    ...
                    {!this.state.regThanks && <div className="g-max-width-5000 text-center mx-auto g-mb-40" style={styles.container}>
                        <span className="mb-4" style={styles.mainText}>4<span style={{color: '#a61d37'}}>0</span>4</span>
                        <span style={styles.subText}>Unauthorized!<br/><span style={{fontSize: '15px'}}>The page you are looking for doesn't exist or an error occured.</span></span>
                    </div>}
                    {/* <!-- End --> */}
                </div>
